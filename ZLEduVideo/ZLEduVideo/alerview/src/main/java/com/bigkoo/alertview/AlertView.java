...
//                margin_alert_left_right = context.getResources().getDimensionPixelSize(R.dimen.margin_actionsheet_left_right);
    ...
    protected void initListView() {
        ...
        if (cancel != null && style == Style.Alert) {
            ...
            tvAlert.setTextColor(context.getResources().getColor(R.color.textColor_alert_msg));
        ...
        AlertViewAdapter adapter = new AlertViewAdapter(itemLayoutId, mDatas, mDestructive);
    ...
    public static class Builder {
        ...
        public Builder setItemLayoutId(int layoutId) {
