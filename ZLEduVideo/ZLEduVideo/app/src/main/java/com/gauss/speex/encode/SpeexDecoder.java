...
/**
 * ����Jspeex���������Ƚ������ogg����ӳ�����Ȼ��ʹ��speex
 * decode��speexתΪwav���ݲ����в���
 * 
 * @author Gauss
 * 
 */
public class SpeexDecoder {
	...
	private SpeexPlayer.OnCompletionListener onCompletionListener;
	...
	public void decode(SpeexPlayer.OnCompletionListener onCompletionListener)
			throws Exception {
