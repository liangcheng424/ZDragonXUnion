...
//            setResult(RESULT_OK, intent);
            Navigation.findNavController(AuthorFragment.this.view).navigateUp();
        }
    }
    ...
    private boolean authorVerification() {
        ...
        String thirdPackageName = getArguments().getString("packageName");
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        Toast.makeText(getContext(), "正在调起应用授权", Toast.LENGTH_SHORT).show();
    ...
    private void goLogin(String thirdAppId) {
        Intent intent = new Intent(getContext(), AuthLoginFragment.class);
    ...
    private void goAgreeAuth(String zlid, String uid, String avarar, String username,String thirdAppId) {
        Intent intent = new Intent(getContext(), AgreeAuthFragment.class);
    ...
    public void autoLogin(final String thirdAppId) {
        String temp = SharePreferencesUtils.getString(getContext(), "encryptzlid", null);
        if (temp != null) {
            DesUtils des = null;
            try {
                des = new DesUtils();
        ...
        ZhulongHttp.Post(getContext(), "getUserInfoZlid", this.getString(R.string.secrectKey_passport), parameters, new HttpCallBack<String>() {
            @Override
