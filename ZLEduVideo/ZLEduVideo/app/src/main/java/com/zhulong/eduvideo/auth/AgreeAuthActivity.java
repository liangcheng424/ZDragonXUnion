 ...
 * 授权页面
 */
public class AgreeAuthActivity extends BaseActivity {
    ...
    protected void initData() {
        mZlid = getIntent().getStringExtra("zlid");
    ...
    protected void initView() {
        ...
        if (!TextUtils.isEmpty(mAvatar)) {
            ZLImageLoader.getInstance().displayImage(this, mAvatar, rivUserAvatar);
        } else {
                        ...
                        if (null != json_header) {
                            ...
                            if (isBack || is_real_mobile == 1) {//已绑定  不需要做其他处理，因为已登录和ZlSession
                                ...
                                startActivityForResult(
                                        MobileNumCheckActivity.newInstance(AgreeAuthActivity.this, 160),
