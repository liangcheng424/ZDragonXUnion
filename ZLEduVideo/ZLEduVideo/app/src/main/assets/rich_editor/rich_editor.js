...
//
////滚动到底部或者顶部 where ：1底部，0顶部
//RE.scrollToTopOrEnd = function(where) {
//    var me = this;
//    me.site = [];
...
//
////图片加载完成回调
//RE.onImageLoaded = function(){
//    document.getElementById('img').onload = function() {
//        window.location.href = "re-imgLoaded";
//    }
//}

//插入图片
RE.insertImage = function(url, alt) {
    var html = '<br/><img  src="' + url + '" alt="' + alt + '" /><br/><br/>';
    RE.insertHTML(html);
}
